...
public abstract class Message {
	...
	public static class ChatMessage extends Message implements Comparable<Message.ChatMessage>{
		...
		public ChatMessage(final UserId recipient, final String msg) {
			...
			this.msg = msg;
			System.out.println("Deserialized ChatMessage: recipient=" + recipient + ", msg=" + msg);
		}
		...
		public int compareTo(ChatMessage o) {
			String[] parts1 = this.getMessage().split("\\|");
			String[] parts2 = o.getMessage().split("\\|");
			System.out.println("This message is" + this.getMessage());
			System.out.println("Other message is" + o.getMessage());
			String thisTimestamp = parts1[2] ;
			String otherTimeStamp = parts2[2];
			System.out.println(thisTimestamp);
			System.out.println(otherTimeStamp);
			if(thisTimestamp.compareTo(otherTimeStamp) > 0) return 1;
			if(thisTimestamp.compareTo(otherTimeStamp) < 0) return -1;
			else return 0;
		}
